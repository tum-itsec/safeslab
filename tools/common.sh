...
export BENCHMARKS
TEST_VM_SSHKEY=${TOOL_DIR}/rootfs-id_ed25519
...
vmstart()
{
    ...
    local kernel_flags="root=/dev/sda rw console=ttyS0 quiet nokaslr net.ifnames=0 clearcpuid=58"
    local dbg=0
    local snapshot=""
